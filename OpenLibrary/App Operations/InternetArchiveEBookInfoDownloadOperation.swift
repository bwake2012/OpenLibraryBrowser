//  InternetArchiveEBookInfoDownloadOperation
//  OpenLibrary
//
...
class InternetArchiveEBookInfoDownloadOperation: GroupOperation {
    // MARK: Properties
    ...
    init( eBookKey: String, cacheFile: NSURL) {

        self.cacheFile = cacheFile
        super.init(operations: [])
        name = "Download eBook Info XML File"
        ...
        */
        let urlString = "https://https://archive.org/download/\(eBookKey)/\(eBookKey)_files.xml"
