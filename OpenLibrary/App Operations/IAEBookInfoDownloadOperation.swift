...
class IAEBookInfoDownloadOperation: GroupOperation {
    // MARK: Properties
    ...
    init( eBookKey: String, cacheFile: URL) {
        ...
        */
        ...
        let task = URLSession.shared.xmlDownloadTaskWithURL( url ) {
